package com.workout_buddy.home.impl.presentation.select_category.ui
...
fun SelectCategoryScreen(
    ...
    Scaffold(
        ...
        floatingActionButton = {
            FloatingActionButton(
                onClick = { /*TODO ADD selected workout*/ },
                shape = RoundedCornerShape(8.dp)
            ) {
                Icon(imageVector = Icons.Filled.Done, contentDescription = "add selected workout")
            }
        }
    ) {
        Column(
            ...
            Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
                ...
                IconButton(onClick = { /*TODO show dialog for add new work category*/ }) {
                    Icon(imageVector = Icons.Filled.Add, contentDescription = "add new workout")
                }
            }
...
fun CategoryItem(
    ...
    Card(
        onClick = { onClick.invoke(data.id) },
